...
public class HubShiftUtil {
  ...
  private static final double minTimeOfFlight = TurretConstants.ACTIVE_PRESHOOT_TIME.in(Seconds);
  private static final double maxTimeOfFlight = TurretConstants.ACTIVE_POSTSHOOT_TIME.in(Seconds);
  ;
