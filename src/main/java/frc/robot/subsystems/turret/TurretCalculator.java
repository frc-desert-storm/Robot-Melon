...
public class TurretCalculator {
  ...
  public static Angle calculateAzimuthAngle(
    ...
    Translation2d turretTranslation =
        new Pose3d(robot).transformBy(ROBOT_TO_TURRET_TRANSFORM).toPose2d().getTranslation();
  ...
  public static ShotData iterativeMovingShotFromFunnelClearance(
    ...
    Time timeOfFlight =
        calculateTimeOfFlight(shot.getLinearExitVelocity(), shot.getHoodAngle(), distance);
