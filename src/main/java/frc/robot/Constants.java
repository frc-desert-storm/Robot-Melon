...
public final class Constants {
  ...
  public static class Dimensions {
    public static final Distance BUMPER_THICKNESS = Inches.of(3.125); // frame to edge of bumper
    public static final Distance BUMPER_HEIGHT = Inches.of(5); // height from floor to top of bumper
    public static final Distance FRAME_SIZE_Y = Inches.of(30.25); // left to right (y-axis)
    public static final Distance FRAME_SIZE_X = Inches.of(24.125); // front to back (x-axis)
